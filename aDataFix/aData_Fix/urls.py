...
urlpatterns = [
    # 1. ZÁKLADNÍ PŘIPOJENÍ (Prefix obstará hlavní urls.py)
    ...
    path('seznam/import_table', views.import_table_view, name='import_table'),
    ...
    # 3. ZÁZNAMY (Editace a mazání konkrétních dat)
